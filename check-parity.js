// Proves ivr-alternate-number-prd.html contains exactly the content of
// IVR_Alternate_Number_PRD.md — nothing extra, nothing missing.
// Run after every build:  node build-html.js && node check-parity.js
//
// Exits 1 on any drift, so it can gate a commit.
const fs = require('fs');
const dir = __dirname + '/';
const md = fs.readFileSync(dir + 'IVR_Alternate_Number_PRD.md', 'utf8');
let html = fs.readFileSync(dir + 'ivr-alternate-number-prd.html', 'utf8');
